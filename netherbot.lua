...
frame:SetScript("OnEvent", function(self, event, ...)
  if event == "PLAYER_REGEN_DISABLED" then
    incombatState = true;
    redemptionButton:disable()
  end
  if event == "PLAYER_REGEN_ENABLED" then
    incombatState = false;
    redemptionButton:enable()
  end
end)
...
adminButton:SetSize(0, 0) --adminButton:SetSize(60, 20)
